...
namespace NoesisGLUT.Osx
{
	...
	public static class FreeGLUT
	{
		...
		private const string LIB_FreeGLUT = "libglut.3.dylib"; // "/opt/X11/lib/libglut.3.dylib"
	...
	{
		private const string LIB_GLUT = "libglut.3.dylib"; // "/opt/X11/lib/libglut.3.dylib"
	...
	{
		private const string LIB_GLU = "/opt/X11/lib/libGLU.dylib"; // "/opt/X11/lib/libGLU.dylib"
	...
	{
	    private const string LIB_GL = "/opt/X11/lib/libGL.dylib"; // "/opt/X11/lib/libGL.1.dylib"
